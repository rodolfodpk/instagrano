...
var _ = Describe("Config", func() {
	...
	Describe("GetZapLevel", func() {
		It("should return correct zap level for different log levels", func() {
	...
	Describe("InvalidDuration", func() {
		It("should handle invalid duration gracefully", func() {
	...
	Describe("InvalidInt", func() {
		It("should handle invalid integer gracefully", func() {
	...
	Describe("PartialEnvironment", func() {
		It("should load partial configuration with some defaults", func() {
